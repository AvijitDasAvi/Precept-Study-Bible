...
import 'package:calvinlockhart/features/auth/forgot_password_verify/controller/forgot_password_verify_controller.dart';
...
class ForgotPasswordVerifyScreen extends StatelessWidget {
  ...
  final ForgotPasswordVerifyController controller = Get.put(
