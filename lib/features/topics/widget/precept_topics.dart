...
class PreceptTopics extends StatelessWidget {
  final bool isDarkMode;

  const PreceptTopics({super.key, required this.isDarkMode});
            ...
            Expanded(
              child: Container(
                ...
                child: ReorderableListView.builder(
                  ...
                  itemCount: controller.preceptTopics.length,
                  onReorder: (oldIndex, newIndex) {
                    controller.reorderTopics(
                      oldIndex,
                      newIndex,
                      TopicType.preceptTopics,
                    );
                  },
                  itemBuilder: (context, index) {
                    final topic = controller.preceptTopics[index];
                    return TopicCard(
